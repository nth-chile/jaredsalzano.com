...
export const testimonials: Testimonial[] = [
    {
        ...
        shorterQuote: <>Jared was a pleasure to work with at our shared time at <span className="logo-group"><span className="logo-link"><L name="elephant" /></span>{" "}Elephant</span> … I could count on Jared to raise important UX, engineering and feasibility considerations. Any team would be lucky to have him.</>,
    ...
    },
    {
        ...
        shorterQuote: "Jared is one of the most creative and determined developers you will ever meet. He brings an all-world mindset to his programming, and is unflappable against challenges and roadblocks as they come up.",
        name: "Adam Spunberg",
